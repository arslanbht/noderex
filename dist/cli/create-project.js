...
class ProjectCreator {
    ...
    async createProject(projectName, options) {
        ...
        this.info(`Creating NodeRex project: ${chalk_1.default.cyan(projectName)}`);
    ...
    createTypeScriptConfig() {
        ...
        fs.writeFileSync(path.join(this.projectPath, 'tsconfig.json'), JSON.stringify(tsConfig, null, 2));
